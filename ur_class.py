...
class UR_Ctrl(object):
    ...
    def pickupbottle(self) :
        ...
        self.robot.up(z=0.150,acc= 0.15, vel=0.2)    
        self.getinfo()
        ...
        while True:
            ...
            if self.rescieve_data:
                ...
                if self.temppose[3] == 'ok' :
                    ...
                    self.robot.movel(self.finalboxcenterpose, acc = 0.05, vel=0.05, wait = True)
                    break
    ...
    def firstBoxLinePosition(self):
        if self.rotate == 1 :
            ...
            self.finalboxcenterpose = self.robot.getl()
            self.firstboxlinepose = [self.finalboxcenterpose[0],self.finalboxcenterpose[1]+0.0225,0.5,self.finalboxcenterpose[3],self.finalboxcenterpose[4],self.finalboxcenterpose[5]]
            self.robot.movel(self.firstboxlinepose, acc = 0.05, vel=0.05, wait = True)
